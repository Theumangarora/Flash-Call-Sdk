...
class MissedCallReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (state == TelephonyManager.EXTRA_STATE_IDLE && !incomingNumber.isNullOrEmpty()) {
            ...
            Log.d("MissedCallReceiver", "onReceive: sdfgbfhbrgvef")

                val preferencesManager = PreferencesManager(context!!)


            Log.d("MissedCallReceiver", "onReceive: rdftyrew4rt")
            ...
            val apiService = RetrofitClient.apiService
                ...
                processMissedCall(context, incomingNumber, id, otpIndex, callback, appId, repository,preferencesManager)
        }
    }
    ...
    private fun processMissedCall(
        ...
        // Log the details
        Log.d("MissedCallReceiver", "ID: $id, Combined Number: $finalCombinedNumber  ${otpIndex}")
